...
export default function NaturalstepperSettime({ boxType }) {
  const {
    squares,
    setSquares,
    // Connect
  ...
  const [minute, setMinute] = useState(
    originalMinute ? originalMinute : originalMinute === 0 ? 0 : "",
  );
  const OriginalSecond = findValue[0]?.data?.duration_sec;
  const [second, setSecond] = useState(
    OriginalSecond ? OriginalSecond : OriginalSecond === 0 ? 0 : "",
  );
  ...
  const [stepsPerMinute, setStepsPerMinute] = useState(
    findValue[0]?.data?.stepsPerMinute || "",
  );
            ...
            <div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setStepsPerMinute(e.target.value)}
              ...
              <div className="mb-[30rem] h-[19rem] text-[12rem]"> (20-180)</div>
            </div>
            <div>
              <div
                className="h-[28rem]  text-[16rem]   text-[#333f48]"
