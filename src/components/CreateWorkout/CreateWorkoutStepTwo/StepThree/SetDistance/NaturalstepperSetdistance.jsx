...
export default function NaturalstepperSetdistance({ boxType }) {
  const {
    squares,
    setSquares,
    // Connect
...
const[stepPerMinute,setStepPerMinute]=useState(findValue[0]?.data?.stepPerMinute || "")
            ...
            <div>
              ...
              <div>
                ...
                <Input
                  ...
                  type="text"
                  value={stepPerMinute}
                  onChange={(e) => setStepPerMinute(e.target.value)}
                  className="h-[42rem] w-[240rem] text-[14rem] font-semibold"
                  style={{
                    letterSpacing: "0.2rem",
                    border: "#84BD00 solid 2rem",
