...
export default function NaturaltreadmillSetcalories({ boxType }) {
  const {
    squares,
    setSquares,
    // Connect
  ...
  const originalIncline = findValue[0]?.data?.incline;
  const [incline, setIncline] = useState(
    originalIncline ? originalIncline : originalIncline === 0 ? 0 : "",
  );
        ...
        <div className="flex flex-col items-center justify-center text-center text-[#333f48]">
          ...
          <div className="mt-[18rem] h-[455rem] w-[293rem] bg-white ">
            ...
            <div>
              ...
              <div className="mb-[30rem] h-[19rem] text-[12rem]"> (0-15%)</div>
            </div>
          </div>
